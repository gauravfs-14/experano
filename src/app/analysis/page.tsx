        ...
        <div className="min-h-screen bg-white text-black">
            <div className="p-6 max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-3xl font-bold Bark:text-gray-800">Event Performance Analysis</h1>
                </div>
                
                <div className="mb-8">
                    <h2 className="text-xl font-semibold mb-4 Bark:text-gray-700">Event Metrics Overview</h2>
                    <div className="grid grid-cols-3 gap-4">
                        {demoData.events.map(event => (
                            <div key={event.id} className="p-4 rounded-lg shadow bg-white border Bark:border-gray-200">
                ...
                <div className="h-[400px]">
                    <h2 className="text-xl font-semibold mb-4 Bark:text-gray-700">Performance Comparison</h2>
